 ...
 * 创建全局噪声生成器
 */
let globalNoiseGenerator: NoiseGenerator | null = null;

export function initGlobalNoiseGenerator(seed: number): NoiseGenerator {
  globalNoiseGenerator = new NoiseGenerator(seed);
  return globalNoiseGenerator;
}

export function getGlobalNoiseGenerator(): NoiseGenerator {
